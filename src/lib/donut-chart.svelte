...
<div class="container">
  <svg viewBox="0 0 100 100" style="width: 100%;height: 100%;">
    <clipPath id="hole">
      <path
        d="M 50 0 a 50 50 0 0 1 0 100 a 50 50 0 0 1 0 -100 v 11 a 2 2 0 0 0 0 78 a 2 2 0 0 0 0 -78"
      ></path>
    </clipPath>
  ...
  <div class="container__text">
    <h4 style="font-size: 48px;font-weight: bold;">{count}%</h4>
    <p style="font-size: 24px;font-weight: bold;">Ram usage</p>
  </div>
</div>
